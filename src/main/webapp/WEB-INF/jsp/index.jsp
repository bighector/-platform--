...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element" style="text-align: center">
                        <span><img alt="image" style="height: 65px;width: 65px;" class="img-circle"
                                   src="${curUser.avatar}"/></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${curUser.userName}</strong></span>
                    ...
                    <c:if test="${menu.type==0}">
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="#">
                                        <a class="J_menuItem" href="${item.url}"><i
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a class="J_menuItem" href="profile.html">
                                    <div>
                            ...
                            <li>
                                <div class="text-center link-block">
                                    <a class="J_menuItem" href="sys/generator/view">
                                        <strong>查看所有 </strong>
        ...
        <div class="row content-tabs">
            ...
            <a @click="logout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i>
                退出</a>
        </div>
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2018 <a href="https://weibo.com/pengjun211314/home?wvr=5&lf=reg"
                                                        target="_blank">lipengjun</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${curUser.avatar}">
