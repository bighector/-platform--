...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
            ...
            //是否主键
            if ("ORACLE".equals(Global.USE_DATA)) {
        ...
        map.put("tablePrefix", tableEntity.getTableName().split("_")[0]);
    ...
    public static String getFileName(String template, TableEntity tableEntity, String packageName) {
        ...
        //表前缀
        String tablePrefix = tableEntity.getTableName().split("_")[0];
        if (StringUtils.isNotBlank(packageName)) {
            packagePath += packageName.replace(".", File.separator) + File.separator;
        }

        if (template.contains("Entity.java.vm")) {
            return packagePath + "entity" + File.separator + tablePrefix + File.separator + className + "Entity.java";
        }

        if (template.contains("Dao.java.vm")) {
            return packagePath + "dao" + File.separator + tablePrefix + File.separator + className + "Dao.java";
        }

        if (template.contains("Dao.xml.vm")) {
            return packagePath + "dao" + File.separator + tablePrefix + File.separator + className + "Dao.xml";
        }

        if (template.contains("Service.java.vm")) {
            return packagePath + "service" + File.separator + tablePrefix + File.separator + className + "Service.java";
        }
        ...
        if (template.contains("Controller.java.vm")) {
            return packagePath + "controller" + File.separator + tablePrefix + File.separator + className + "Controller.java";
        }

        if (template.contains("list.jsp.vm")) {
            return "main" + File.separator + "webapp" + File.separator + "WEB-INF" + File.separator + "jsp"
                    + File.separator + tablePrefix + File.separator + className.toLowerCase() + ".jsp";
        }
